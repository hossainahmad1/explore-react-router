...
1.create a Link (to): so that you can go to this route
2.Create component: to add what you will show once you go to that route;
3.Add route so that react router know the component it needs to display while do you are visiting to that route
